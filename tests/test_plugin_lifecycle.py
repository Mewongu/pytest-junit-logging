...
from pytest_junit_logging.plugin import (
    ...
    pytest_runtest_teardown, pytest_fixture_setup, pytest_fixture_post_finalizer,
...
<testsuites name="pytest tests">
    <testsuite name="pytest" errors="0" failures="0" skipped="0" tests="2" time="0.02">
        ...
        with patch('pytest_junit_logging.plugin.add_logs_to_testcase') as mock_add_logs:
            ...
            expected_calls = [
                call(mock_add_logs.call_args_list[0][0][0], "tests.test_example.TestClass.test_method_a"),
                call(mock_add_logs.call_args_list[1][0][0], "tests.test_example.TestClass.test_method_b")
            ]
